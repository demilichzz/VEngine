...
public class VStage implements VKeyProcessorInterface{
	...
	public int getfsmState(){
		// TODO 获取状态
		return fsm_stage.GetCurrentState();
	}
	...
	public void processInput(){
		VEngine.newgame.kcontroller.keyAction();
		VEngine.newgame.mcontroller.mouseAction();
		/*if(VEngine.newgame.kcontroller.isKeyDown(VKeyController.KEY_ADD)){
			Debug.DebugSimpleMessage("draw a card");
			GameData.player.handcard.drawCard();
			VEngine.newgame.kcontroller.setKeydelay(VKeyController.KEY_ADD);	//为该按键设置按键延迟
		}*/
	}
}
